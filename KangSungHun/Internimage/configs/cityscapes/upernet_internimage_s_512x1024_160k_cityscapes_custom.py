...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', #custom_file
    '../_base_/datasets/cityscapes_custom.py', #custom_file
    '../_base_/default_runtime.py', 
    '../_base_/schedules/schedule_160k.py'
]
pretrained = 'https://huggingface.co/OpenGVLab/InternImage/resolve/main/upernet_internimage_s_512x1024_160k_cityscapes.pth'
model = dict(
    backbone=dict(
        _delete_=True,
        type='InternImage',
